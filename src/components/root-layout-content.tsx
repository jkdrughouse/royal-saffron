...
// Routes that should render without any site chrome (header / footer / nav)
const PRINT_ROUTES = ["/admin/receipt"];
...
export function RootLayoutContent({ children }: { children: React.ReactNode }) {
    ...
    // Print routes: render children bare — no header, footer, or floating buttons
    if (isPrintRoute) {
