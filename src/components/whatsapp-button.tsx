...
export function WhatsAppButton({ 
    ...
    return (
        <Link
            ...
            className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105 flex items-center gap-2 px-4 py-3 sm:px-5 sm:py-4 ${className}`}
